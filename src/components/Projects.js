...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      desc: "Full-featured library system with JWT auth, borrowing logic, and role-based access. Built with FastAPI (async), PostgreSQL, and SQLAlchemy ORM. Optimized queries reduced response time by 60%.",
    ...
    },
    {
      ...
      desc: "Secure backend handling doctors, patients, appointments, and medical records. Built with async FastAPI, SQLAlchemy, and token-based auth. Implemented foreign key constraints and data integrity checks for reliability.",
      link: "https://hospital-management-system1-o63yod5j9-erishprajatis-projects.vercel.app/api/v1/login_view",
    ...
    <section className="projects-section" id="projects">
      <div className="container projects-container">
        ...
        <div className="projects-footer">
          <a href="#projects" className="see-all-link">See all projects</a>
        </div>
      </div>
    </section>
  );
